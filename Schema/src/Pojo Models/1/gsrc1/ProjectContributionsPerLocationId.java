...
/**
 * ProjectContributionsPerLocationId generated by hbm2java
 */
@Embeddable
public class ProjectContributionsPerLocationId implements java.io.Serializable {

	private Integer projectId;
	private Serializable source;

	public ProjectContributionsPerLocationId() {
	}

	public ProjectContributionsPerLocationId(Integer projectId, Serializable source) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProjectContributionsPerLocationId))
			return false;
		ProjectContributionsPerLocationId castOther = (ProjectContributionsPerLocationId) other;
